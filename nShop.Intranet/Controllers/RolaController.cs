...
namespace nShop.Intranet.Controllers
{
    public class RolaController : Controller
    {
        ...
        public RolaController(nShopIntranetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nazwa,Opis")] Rola rola)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nazwa,Opis")] Rola rola)
        {
            if (id != rola.Id)
            {
                return NotFound();
